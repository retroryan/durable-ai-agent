#!/usr/bin/env python3
"""Test the docker-compose MCP proxy using FastMCP client."""
...
async def test_docker_proxy():
    """Test the proxy running in docker-compose."""
    # Connect to the proxy server running on port 8001
    proxy_url = "http://localhost:8001/mcp"

    print(f"Connecting to docker-compose proxy at {proxy_url}...")
